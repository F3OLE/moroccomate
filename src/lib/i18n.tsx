...
const messages = {
  en: {
    ...
    upclose_label: 'Up close',
    upclose_title: 'The Morocco you won’t see anywhere else',
    upclose_sub:
      'Faces, crafts, and everyday moments. The side of Morocco that stays with you after the trip.',
    uc_doorway: 'A medina doorway and its resident cat',
    uc_water: 'A guerrab water seller by the Koutoubia',
    uc_guide: 'A desert guide at golden hour',
    uc_tbourida: 'Tbourida, the fantasia horse show',
    uc_tanneries: 'The leather tanneries of Fez',
    uc_chebakia: 'Fresh chebakia, honey and sesame',
    uc_tea: 'Mint tea, poured from high',
    uc_signs: 'Hand-painted souk signs',
    open: 'Open',
    ...
    gate_xp_locked: 'experiences locked',
    gate_xp_title: 'Unlock every experience',
    gate_xp_sub:
      'Sahara nights, Atlas hikes, cooking classes, and more. Free with early access to MoroccoMate.',
    gate_xp_cta: 'Unlock all experiences',
  ...
  fr: {
    ...
    upclose_label: 'De près',
    upclose_title: 'Le Maroc que vous ne verrez nulle part ailleurs',
    upclose_sub:
      'Des visages, de l’artisanat et des moments du quotidien. Le Maroc qui vous reste après le voyage.',
    uc_doorway: 'Une porte de médina et son chat',
    uc_water: 'Un guerrab, porteur d’eau, près de la Koutoubia',
    uc_guide: 'Un guide du désert à l’heure dorée',
    uc_tbourida: 'La tbourida, la fantasia à cheval',
    uc_tanneries: 'Les tanneries de Fès',
    uc_chebakia: 'Chebakia fraîche, miel et sésame',
    uc_tea: 'Le thé à la menthe, versé de haut',
    uc_signs: 'Enseignes du souk peintes à la main',
    open: 'Ouvrir',
    ...
    gate_xp_locked: 'expériences verrouillées',
    gate_xp_title: 'Débloquez toutes les expériences',
    gate_xp_sub:
      'Nuits au Sahara, randonnées dans l’Atlas, cours de cuisine et plus encore. Gratuit avec l’accès anticipé à MoroccoMate.',
    gate_xp_cta: 'Tout débloquer',
  ...
  es: {
    ...
    upclose_label: 'De cerca',
    upclose_title: 'El Marruecos que no verás en ningún otro sitio',
    upclose_sub:
      'Rostros, artesanía y momentos cotidianos. El lado de Marruecos que te llevas a casa.',
    uc_doorway: 'Una puerta de la medina y su gato',
    uc_water: 'Un guerrab, aguador, junto a la Kutubía',
    uc_guide: 'Un guía del desierto al atardecer',
    uc_tbourida: 'La tbourida, la fantasía a caballo',
    uc_tanneries: 'Las curtidurías de Fez',
    uc_chebakia: 'Chebakia recién hecha, miel y sésamo',
    uc_tea: 'Té a la menta, servido desde lo alto',
    uc_signs: 'Carteles del zoco pintados a mano',
    open: 'Abrir',
    ...
    gate_xp_locked: 'experiencias bloqueadas',
    gate_xp_title: 'Desbloquea todas las experiencias',
    gate_xp_sub:
      'Noches en el Sáhara, rutas por el Atlas, clases de cocina y mucho más. Gratis con el acceso anticipado a MoroccoMate.',
    gate_xp_cta: 'Desbloquear todo',
